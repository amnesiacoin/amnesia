...
RESOURCES += src/qt/amnesia.qrc src/qt/amnesia_locale.qrc

TRANSLATIONS += src/qt/locale/amnesia_bg.ts \
                src/qt/locale/amnesia_de.ts \
                src/qt/locale/amnesia_en.ts \
                src/qt/locale/amnesia_es.ts \
                src/qt/locale/amnesia_fi.ts \
                src/qt/locale/amnesia_fr.ts \
                src/qt/locale/amnesia_it.ts \
                src/qt/locale/amnesia_ja.ts \
                src/qt/locale/amnesia_pl.ts \
                src/qt/locale/amnesia_pt.ts \
                src/qt/locale/amnesia_ru.ts \
                src/qt/locale/amnesia_sk.ts \
                src/qt/locale/amnesia_sv.ts \
                src/qt/locale/amnesia_vi.ts \
                src/qt/locale/amnesia_zh_CN.ts \
                src/qt/locale/amnesia_zh_TW.ts
