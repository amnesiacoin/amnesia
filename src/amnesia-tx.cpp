...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Amnesia Core amnesia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  amnesia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded amnesia transaction") + "\n" +
                               "  amnesia-tx [options] -create [commands]   " + _("Create hex-encoded amnesia transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded amnesia transaction
