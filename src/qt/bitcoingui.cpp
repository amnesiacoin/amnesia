                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Amnesia Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AMNZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and amnesia: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Amnesia Core"), this);
    aboutAction->setStatusTip(tr("Show information about Amnesia Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Amnesia"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AMNZ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AMNZ addresses"));
    ...
    openAction->setStatusTip(tr("Open a amnesia: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Amnesia Core help message to get a list with possible Amnesia command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Amnesia Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Amnesia network", "", count));
}
...
{
    QString strTitle = tr("Amnesia Core"); // default title
