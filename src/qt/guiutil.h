...
/** Utility functions used by the Amnesia Qt UI.
 */
namespace GUIUtil
{
...
// Render AMNZ addresses in monospace font
...
// Parse "amnesia:" URI into recipient object, return true on successful parsing
