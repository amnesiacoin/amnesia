...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Amnesia server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Amnesia features */
        {"amnesia", "masternode", &masternode, true, true, false},
        {"amnesia", "listmasternodes", &listmasternodes, true, true, false},
        {"amnesia", "getmasternodecount", &getmasternodecount, true, true, false},
        {"amnesia", "masternodeconnect", &masternodeconnect, true, true, false},
        {"amnesia", "masternodecurrent", &masternodecurrent, true, true, false},
        {"amnesia", "masternodedebug", &masternodedebug, true, true, false},
        {"amnesia", "startmasternode", &startmasternode, true, true, false},
        {"amnesia", "createmasternodekey", &createmasternodekey, true, true, false},
        {"amnesia", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"amnesia", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"amnesia", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"amnesia", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"amnesia", "getmasternodescores", &getmasternodescores, true, true, false},
        {"amnesia", "mnbudget", &mnbudget, true, true, false},
        {"amnesia", "preparebudget", &preparebudget, true, true, false},
        {"amnesia", "submitbudget", &submitbudget, true, true, false},
        {"amnesia", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"amnesia", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"amnesia", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"amnesia", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"amnesia", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"amnesia", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"amnesia", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"amnesia", "checkbudgets", &checkbudgets, true, true, false},
        {"amnesia", "mnsync", &mnsync, true, true, false},
        {"amnesia", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> amnesia-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36662/\n";
}
