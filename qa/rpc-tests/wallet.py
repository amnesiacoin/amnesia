...
#   c) node1 mines 32 blocks, so now node 0 has 500000AMNZ, node 1 has 4250AMNZ, node2 has none.
#   d) node0 sends 601 AMNZ to node2, in two transactions (301 AMNZ, then 300 AMNZ).
