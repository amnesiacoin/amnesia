...
In order to support loading of multiple wallets in amnesia-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is amnesia.cpp.
...
Changes to amnesia.cpp
----------------------
amnesia.cpp is the entry point into amnesia-qt, and as such, will require some minor modifications to provide hooks for
