...
Intro
-----
Amnesia (AMNZ) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Amnesia utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run amnesia-qt.exe.

Amnesia Core is the original Amnesia client and it builds the backbone of the network.
However, it downloads and stores the entire history of Amnesia transactions;
