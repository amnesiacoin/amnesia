Contributing to Amnesia Core
==================================

The Amnesia Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Amnesia Core project, and is not to be
confused with overall Amnesia Network Protocol consensus changes.

Whether a pull request is merged into Amnesia Core rests with the project merge
...
Patches that change Amnesia consensus rules are considerably more involved than
...
Where a patch set proposes to change the Amnesia consensus, it must have been
...
The project leader is the release manager for each Amnesia Core release.
